...
regretfile= "Rslt/SPO_{}_Regret.csv".format(exp)
ckpt_dir =  "ckpt_dir/SPO_{}/".format(exp)
log_dir = "lightning_logs/SPO_{}/".format(exp)
...
for seed in range(10):
    ...
    model = SPO( param=param, lr=lr, seed=seed, max_epochs=max_epochs )
...
df['model'] ='SPO'
df.to_csv("LearningCurve/SPO_{}.csv".format(exp))