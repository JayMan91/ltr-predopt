...
outputfile = "Rslt/Pointwise_rslt.csv"
regretfile= "Rslt/Pointwise_Regret.csv"
...
for seed in range(10):
    ...
    init_cache=init_cache, loss_fn=pointwise_loss, net=nn.Linear(5,40), growth= growth,lr= lr,l1_weight=l1_weight, seed=seed, )
