...
outputfile = "Rslt/NCE_rslt.csv"
regretfile= "Rslt/NCE_Regret.csv"
ckpt_dir =  "ckpt_dir/NCE/"
log_dir = "lightning_logs/NCE/"
...
for seed in range(10):
    ...
    model = CachingPO(init_cache=init_cache, loss_fn= NCE_hatc_c, net=nn.Linear(5,40), growth= growth,
    ...
    init_cache=init_cache,loss_fn= NCE_hatc_c, net=nn.Linear(5,40), growth= growth,lr= lr,l1_weight=l1_weight, seed=seed, )
...
df = pd.DataFrame({"step": steps,'wall_time':walltimes,  "val_regret": regrets,
 "val_mse": mses })
df['model'] ='NCE_hatc_c'
df.to_csv("LearningCurve/NCE_data_N_{}_noise_{}_deg_{}_growth{}.csv".format(N,noise,deg,growth))